...
<body>
	...
	<form action="./ServletAjouterArticle" method="post">
		...
		<label id="label_categorie">Catégorie : </label><select name="categorie">
							<%
		...
		<label id="label_debut_enchere">Début de l'enchère : </label><input type="date" name="input_date_debut_enchere"><br>
		<label id="label_fin_enchere">Fin de l'enchère : </label><input type="date" name="input_date_fin_enchere"><br>
		<br>
